    ...
    return (
        <div className="h-screen flex  md:flex-row flex-col gap-10 justify-around items-center">
            <div className="card w-96 h-[500px] rounded bg-[#5C8374] p-10">
                <h3 className="text-3xl text-white text-center mb-4 font-bold">Welcome Back Safichat</h3>
                <form>
                    <div className="mb-4">
                    ...
                    <div className="mb-4">
                        <button type="submit" className="py-2 w-full  rounded-md bg-[#1B4242] text-white">Login</button>
                    </div>
                    <div>
                    <p className='text-white'>New user? please <Link to="/register"><span className='text-blue-500 underline'>Register</span></Link></p>
